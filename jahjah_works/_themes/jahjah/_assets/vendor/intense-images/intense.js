...
var Intense = (function() {
    ...
    function createViewer( title, caption, imageClass ) {
      ...
      container.setAttribute('class', imageClass);
    ...
    function init( element, imageClass ) {

      var imageSource = element.getAttribute( 'data-image') || element.src;
      var title = element.getAttribute( 'data-title');
      var caption = element.getAttribute( 'data-caption');
      var imageClass = element.getAttribute('data-class') || 'intense-images--container';
      ...
      img.onload = function() {
        ...
        target = this;
        createViewer( title, caption, imageClass );
        lockBody();
        bindEvents();
        loop();
      }
